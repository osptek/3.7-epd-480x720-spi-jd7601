...
<p align="center"><b>六色电子纸 · SPI · JD7601 · 多版本索引</b></p>
...
本仓库收录 **3.7 寸 480×720 EPD（SPI · JD7601）** 显示模组资料。
...
| 版本 | 宣传图 | 简介 | 完整资料 |
| ---- | ------ | ---- | -------- |
| EPD037A02 | <img alt="EPD037A02" src="./versions/EPD037A02/images/product.png" width="120" /> | [简介](#epd037a02) | [完整资料](./versions/EPD037A02/) |
...
**说明：** FPC 为 32 Pin，六色（黑 / 白 / 红 / 黄 / 蓝 / 绿），无触摸。

完整产品页、规格书与示例：[versions/EPD037A02/](./versions/EPD037A02/)
